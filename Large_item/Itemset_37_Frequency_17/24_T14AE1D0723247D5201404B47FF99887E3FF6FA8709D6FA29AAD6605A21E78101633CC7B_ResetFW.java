...
public final class ResetFW extends Flyweight {
  ...
  @Override
  public ResetFW tryWrap(DirectBuffer buffer, int offset, int maxLimit) {
  ...
  public String toString() {
    return String.format("RESET [routeId=%d, streamId=%d, sequence=%d, acknowledge=%d, maximum=%d, timestamp=%d, traceId=%d, authorization=%d, extension=%s]", routeId(), streamId(), sequence(), acknowledge(), maximum(), timestamp(), traceId(), authorization(), extension());
  }
