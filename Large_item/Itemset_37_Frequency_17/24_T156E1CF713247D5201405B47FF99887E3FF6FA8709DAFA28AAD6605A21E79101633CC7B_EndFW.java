...
public final class EndFW extends Flyweight {
  ...
  @Override
  public EndFW tryWrap(DirectBuffer buffer, int offset, int maxLimit) {
  ...
  public String toString() {
    return String.format("END [routeId=%d, streamId=%d, sequence=%d, acknowledge=%d, maximum=%d, timestamp=%d, traceId=%d, authorization=%d, extension=%s]", routeId(), streamId(), sequence(), acknowledge(), maximum(), timestamp(), traceId(), authorization(), extension());
  }
