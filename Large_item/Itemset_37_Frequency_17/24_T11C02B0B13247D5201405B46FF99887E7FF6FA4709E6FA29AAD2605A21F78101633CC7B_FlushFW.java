...
public final class FlushFW extends Flyweight {
  ...
  public static final int FIELD_OFFSET_BUDGET_ID = FIELD_OFFSET_AUTHORIZATION + FIELD_SIZE_AUTHORIZATION;
  ...
  public static final int FIELD_OFFSET_EXTENSION = FIELD_OFFSET_RESERVED + FIELD_SIZE_RESERVED;

  public static final int TYPE_ID = 0x00000005;
  ...
  public String toString() {
    return String.format("FLUSH [routeId=%d, streamId=%d, sequence=%d, acknowledge=%d, maximum=%d, timestamp=%d, traceId=%d, authorization=%d, budgetId=%d, reserved=%d, extension=%s]", routeId(), streamId(), sequence(), acknowledge(), maximum(), timestamp(), traceId(), authorization(), budgetId(), reserved(), extension());
  }

  public static final class Builder extends Flyweight.Builder<FlushFW> {
    ...
    private static final int INDEX_BUDGET_ID = 8;

    private static final int INDEX_RESERVED = 9;
    ...
    private OctetsFW.Builder extension() {
      if (lastFieldSet < INDEX_RESERVED) {
