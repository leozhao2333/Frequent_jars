...
public final class DeleteResourcePolicyResponse extends KinesisResponse implements
    ...
    public final String toString() {
        return ToString.builder("DeleteResourcePolicyResponse").build();
    }
    ...
    public interface Builder extends KinesisResponse.Builder, SdkPojo, CopyableBuilder<Builder, DeleteResourcePolicyResponse> {
    }
