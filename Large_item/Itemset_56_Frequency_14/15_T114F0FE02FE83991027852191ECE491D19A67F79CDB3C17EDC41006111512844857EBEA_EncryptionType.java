...
public enum EncryptionType {
    ...
    private static final Map<String, EncryptionType> VALUE_MAP = EnumUtils.uniqueIndex(EncryptionType.class,
     ...
     *
     * @return a {@link Set} of known {@link EncryptionType}s
     */
    public static Set<EncryptionType> knownValues() {
        Set<EncryptionType> knownValues = EnumSet.allOf(EncryptionType.class);
